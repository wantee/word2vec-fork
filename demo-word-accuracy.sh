...
time ./word2vec -train text8 -output vectors.bin -cbow 1 -size 200 -window 8 -negative 0 -hs 1 -sample 1e-4 -threads 4 -binary 1 -iter 15 -rebuild 1 -read-vocab vocab
