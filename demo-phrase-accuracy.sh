...
time ./word2vec -train news.2012.en.shuffled-norm1-phrase1 -output vectors-phrase.bin -cbow 1 -size 200 -window 10 -negative 0 -hs 1 -sample 1e-5 -threads 12 -binary 1 -iter 15 -rebuild 1 -read-vocab news.2012.vocab
